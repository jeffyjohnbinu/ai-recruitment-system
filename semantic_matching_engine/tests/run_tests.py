...
----------------------
Runs the full pytest suite for the Semantic Matching Engine and writes a
...
def run():
    ...
    cmd = [sys.executable, "-m", "pytest", str(THIS_DIR / "test_matching.py"), "-v", "--tb=short"]

    header = (
        f"Semantic Matching Engine — Automated Test Run\n"
