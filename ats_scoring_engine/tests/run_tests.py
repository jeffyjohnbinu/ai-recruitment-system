...
----------------------
Runs the full pytest suite for the ATS Scoring Engine and writes a
...
def run():
    ...
    cmd = [
        ...
        "-m",
        "pytest",
        str(THIS_DIR / "test_scoring_engine.py"),
        str(THIS_DIR / "test_generator.py"),
        "-v",
        "--tb=short",
    ]

    header = (
        f"ATS Scoring Engine — Automated Test Run\n"
