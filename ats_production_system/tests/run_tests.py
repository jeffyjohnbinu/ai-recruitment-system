...
----------------------
Runs the full pytest suite for the ATS Production System and writes a
...
def run():
    ...
    cmd = [
        ...
        "-m",
        "pytest",
        str(THIS_DIR / "test_integration.py"),
        "-v",
        "--tb=short",
    ]

    header = (
        f"ATS Production System — Automated End-to-End Test Run\n"
